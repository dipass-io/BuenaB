...
if (window.history.pushState) {
  ...
  (window.history.pushState = function() {
    ...
    originalReplaceState.call(window.history, e, ""),
  ...
  var timeoutHandle = null,
    ...
    tryToScrollTo = function e(t) {
      ...
      (r + scrollBarWidth - window.innerWidth >= t.x &&
        i + scrollBarWidth - window.innerHeight >= t.y) ||
      Date.now() > t.latestTimeToTry
      ...
      (r.closeModal = function(e) {
        var t = c(n || l, e || {}),
          r = document.querySelector(
            t.selectorWindow + "." + t.modalActiveClass
          );
        r &&
          (d(r, t),
        ...
        (r.openModal = function(e, i, s) {
          ...
          "open" === a && r.closeModal(d),
            ...
            u.focus(),
            d.preventBGScroll &&
              (d.preventBGScrollHtml &&
                (document.documentElement.style.overflowY = "hidden"),
              d.preventBGScrollBody &&
      ...
      var p = function(e, t, o) {
          if (o)
            return (
              ...
              void e.removeEventListener("click", d, !1)
            );
            ...
            var n,
              ...
              s = function(e) {
                (a = e.changedTouches[0].pageX - r),
                  (l = e.changedTouches[0].pageY - i),
                  Math.abs(a) >= 7 || Math.abs(l) >= 10 || t(e);
              },
              d = function(e) {
        ...
        w = function(e) {
          var t = e.target,
            ...
            c = e.keyCode;
          if (c && "open" === a)
            (27 === c || (n.backspaceClose && (8 === c || 46 === c))) &&
              r.closeModal();
          else if (t) {
            if (l && !i) return;
            !o || (c && 13 !== c)
              ...
              : (e.preventDefault(),
                r.openModal(o, o.getAttribute("data-modal"), n));
          }
        };
      return (
        (r.destroy = function() {
      ...
      var p = function() {
        ...
        v = function() {
          ...
          return (
            ...
            !(e == r || !n.options.vertical) ||
              !(t == a || !n.options.horizontal)
          );
        },
        h = function(e, t, o) {
          var r = {},
  ...
  (function() {
    var e,
      ...
      n =
        ...
        document.querySelector("[data-scroll-indicator]")),
      r = Power4.easeInOut,
      i = ".6",
      a = o.offsetHeight,
      l = "is-active",
    ...
    var m = function(e) {
      ...
      S = function(e) {
        TweenMax.from(e, i, {
          ...
          opacity: "0",
          onStart: function() {
            document.querySelector("[data-graphic]") &&
      ...
      x = function(e) {
        if (e.querySelector("[data-content-nav]")) {
          ...
          if (o.querySelector("[data-content-nav]"))
            ...
            (n.className = "content-nav"),
              n.setAttribute("data-content-nav", ""),
      ...
      C = function(e) {
        e >= a
          ? (o.classList.add(s), n.classList.add(c))
          : (o.classList.remove(s), n.classList.remove(c));
      },
      q = function(e) {
        var t = w(e.target, "a");
        if (
          !((t && 3 === e.which) || 2 === e.which || e.metaKey || e.ctrlKey)
        ) {
          ...
          t && t.hasAttribute("data-scroll") && (e.preventDefault(), E(t)),
            t &&
              t.hasAttribute("data-scroll-indicator") &&
              (e.preventDefault(), A());
        }
      },
      M = v(function(e) {
